...
type EventBasedFilter struct {
	...
	Self        interface{}
	mu          sync.Mutex
	dataSeries  common.SequenceDataSeries
	eventWindow *EventWindow
}

func NewEventBasedFilter(dataSeries common.SequenceDataSeries, eventWindow *EventWindow, maxLen int) *EventBasedFilter {
	...
	res.dataSeries.GetNewValueEvent().Subscribe(func(args ...interface{}) error {
		d := args[0].(common.SequenceDataSeries)
		t := args[1].(*time.Time)
		v := args[2]
...
func (f *EventBasedFilter) onNewValue(dataSeries common.SequenceDataSeries, dateTime *time.Time, value interface{}) error {
...
func (f *EventBasedFilter) GetDataSeries() common.SequenceDataSeries {
	return f.dataSeries
}
